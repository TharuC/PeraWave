...
const Navbar: React.FC<NavbarProps> = ({ 
  ...
  return (
    <nav className="navbar">
      <div className="logo-container" style={{ cursor: "pointer" }} onClick={() => navigate(isLoggedIn ? "/home" : "/")}>
            ...
            <div className="nav-profile-menu" style={{ position: "relative" }}>
              ...
              {isDropdownOpen && (
                  <div className="profile-dropdown" style={{
                      ...
                      <div className="dropdown-item" style={{ padding: '10px 20px', cursor: 'pointer', fontSize: '14px', fontWeight: 500, color: '#475569' }} onClick={() => navigate('/home')}>
                          Home
                      </div>
