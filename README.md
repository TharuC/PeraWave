...
PeraWave/
└── Code/
    ├── PeraWaveFrontEnd/    # React + Vite frontend
    └── PeraWaveBackEnd/     # Node.js + Express backend
```
...
* Component-based frontend architecture using Vite
* Modern client-side routing with React Router
